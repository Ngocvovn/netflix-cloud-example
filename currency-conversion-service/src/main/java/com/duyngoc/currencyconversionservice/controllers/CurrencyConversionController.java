package com.duyngoc.currencyconversionservice.controllers;

import com.duyngoc.currencyconversionservice.models.CurrencyConversion;
import com.duyngoc.currencyconversionservice.services.CurrencyExchangeServiceProxy;
...
public class CurrencyConversionController {
   ...
   /* public CurrencyConversion convertCurrency(@PathVariable String from, @PathVariable String to
    , @PathVariable BigDecimal quantity) {
        ...
        System.out.println(response.getFrom() + " " + response.getTo());
